...
namespace ConsoleUI
{
    class Program
    {
        ...
        //{
        //    userManager.Add(new User { UserId = 1, FirstName = "can", LastName = "cano", Email = "dasda@hotmail.com", Password = "123456" });

        //    customerManager.Add(new Customer { CustomerId = 1, UserId = 1, CompanyName = "cano" });

        //    rentalManager.Add(new Rental { RentalId = 1, CarId = 2, CustomerId = 1, RentDate = new DateTime(2020, 02, 20), ReturnDate = new DateTime(2020, 01, 10) });
        //}
